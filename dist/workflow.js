...
export default createWorkflow(workflowId, 'Temp Mail Open Latest')
    ...
    const mailboxUrl = String(ctx.getConfig(`${prefix}.mailboxUrl`, 'https://example.com/mailbox'));
    ...
    root
        ...
        b.predicateFn(() => Boolean(refreshSelector))
            .whenTrue(new SequenceNodeBuilder('refresh-sequence')
            ...
            .whenFalse(new ToolNodeBuilder('skip-refresh-mailbox', 'console_execute').input({
